...
def send_email():
    ...
    EMAIL_ADDRESS = "gudujadhav007@gmail.com"
    EMAIL_PASSWORD = "iypg sllt qvkh uvsy"  # Use an App Password

    # Get current date & time
    now = datetime.now()
    date = now.strftime("%m_%d_%y")  # Matches your file format

    # Email Subject & Body
    msg = EmailMessage()
    msg['Subject'] = f"Today's Attendance Report - {date}"
   ...
   # EMAIL_ADDRESS = "gudujadhav007@gmail.com"
   # EMAIL_PASSWORD = "iypg sllt qvkh uvsy"
